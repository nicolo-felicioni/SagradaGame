 ...
 */
public class MoveDieRespectAllRestrictionsGameEvent extends AbstractMoveDieGameEvent {
	 ...
	 */
	public MoveDieRespectAllRestrictionsGameEvent(Point initialPosition, Point finalPosition, String playerId) {
