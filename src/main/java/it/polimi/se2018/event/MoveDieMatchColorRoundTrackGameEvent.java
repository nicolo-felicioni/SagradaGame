 ...
 */
public class MoveDieMatchColorRoundTrackGameEvent extends AbstractMoveDieGameEvent {
	 ...
	 */
	public MoveDieMatchColorRoundTrackGameEvent(Point initialPosition, Point finalPosition, String playerId) {
