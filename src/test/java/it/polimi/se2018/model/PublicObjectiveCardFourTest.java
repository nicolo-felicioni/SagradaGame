 ...
 */
public class PublicObjectiveCardFourTest {
	private WindowPattern window;
	private PublicObjectiveCardFour card;

	@Before
	public void setUp(){
		card = new PublicObjectiveCardFour();
	}
	...
	public void testCalculatePoints3() {
		try {
			...
			spaces[1][0].placeDie(new Die(DieColor.BLUE, DieValue.TWO));
			spaces[1][1].placeDie(new Die(DieColor.BLUE, DieValue.THREE));
			spaces[1][2].placeDie(new Die(DieColor.BLUE, DieValue.FOUR));
			spaces[1][3].placeDie(new Die(DieColor.BLUE, DieValue.FIVE));
			spaces[1][4].placeDie(new Die(DieColor.BLUE, DieValue.SIX));
